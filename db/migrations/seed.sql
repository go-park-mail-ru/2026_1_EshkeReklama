...
INSERT INTO eshekere.topic (name) VALUES ('Авто'), ('IT и Технологии'), ('Красота и здоровье'), ('Образование');

INSERT INTO eshekere.region (name) VALUES ('Москва'), ('Санкт-Петербург'), ('Новосибирск'), ('Казань');

-- 2. Рекламодатели (Advertisers)
INSERT INTO eshekere.advertiser (name, email, phone_number, password_hash, password_salt, balance)
VALUES
...
INSERT INTO eshekere.ad_campaign (advertiser_id, name, daily_budget, status)
VALUES
...
INSERT INTO eshekere.ad_group (ad_campaign_id, topic_id, region_id, name, age_from, age_to, gender)
VALUES
    (1, 4, 2, 'Женщины Москва 25-45', 25, 45, 'woman'),
    (3, 3, 1, 'Разработчики РФ 18-99', 18, 99, 'any');

-- 5. Сами объявления (Ads)
INSERT INTO eshekere.ad (ad_group_id, status, title, short_desc, image_url, target_url)
VALUES
...
INSERT INTO eshekere.partner (name, email, phone_number, password_hash, password_salt, balance)
VALUES ('Сергей Владелец Блога', 'sergey@blog.ru', '9115554422', 'hash789', 'salt789', 0.00);

INSERT INTO eshekere.partner_site (partner_id, topic_id, region_id, age_from, age_to, gender, url)
...
INSERT INTO eshekere.ad_action (ad_id, partner_site_id, region_id, action, age, gender)
VALUES
    (1, 1, 2, 'look', 30, 'woman'),
    (1, 1, 2, 'look', 28, 'woman'),
